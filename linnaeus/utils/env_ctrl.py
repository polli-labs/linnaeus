...
def load_yaml_env(path: Union[str, Path]) -> Dict[str, str]:
...
def merge_yaml_env(base: Dict[str, str], yaml_path: Optional[Union[str, Path]]) -> Dict[str, str]:
...
def write_env_dump(env: Dict[str, str], output_path: Union[str, Path]) -> None:
    ...
    with open(output_path, 'w') as f:
        ...
        f.write(f"# Generated at startup for reproducibility\n\n")
